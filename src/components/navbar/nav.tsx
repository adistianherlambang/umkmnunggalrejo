  ...
  return (
    <nav className={styles.navbar}>
      ...
      <ul className={styles.link}>
        ...
        <li><Link href="/product" className={styles.isi}><p className={styles.text}>Produk</p></Link></li>
        <li><Link href="/" className={styles.isi}><p className={styles.text}>Tentang Kami</p></Link></li>
      </ul>
      <div className={styles.button}>
        <Link href="https://wa.me/62895636126916" className={styles.text}>Contact Us</Link>
      </div>
      ...
      <ul className={`${styles.navLinks} ${isMenuOpen ? styles.active : ""}`}>
        ...
        <li><Link href="/product" className={styles.navLink}><p className={styles.text}>Produk</p></Link></li>
        <li><Link href="/" className={styles.navLink}><p className={styles.text}>Tentang Kami</p></Link></li>
        <li>
            <Link href="https://wa.me/62895636126916"  className={styles.buttonres}>
