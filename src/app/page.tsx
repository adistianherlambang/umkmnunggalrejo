...
import CarouselSize from "@/components/Caraousel";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.circle}>
        <Image src="/home/bg.png" width={1000} height={1000} alt="bg" />
      </div>
      <div className={styles.header}>
        <p className={styles.headerTitle}>
          Official Website Terpercaya,
          <br />
          <span className={styles.headerBold}>Produk Berkualitas</span> Khas
          UMKM Desa Nunggal Rejo{" "}
          <svg
      ...
      <div className={styles.header2}>
        <p className={styles.header2Text}>
          Membeli produk unggulan desa
          <br />
          berarti membantu kesejahteraannya
        </p>
        <Image
        ...
        <Link className={styles.headerRight} href="/product">
          <div className={styles.headerRightContent}>
            ...
            >
              ...
              <path
                d="M15 24.8414C13.8078 24.8414 12.8414 25.8078 12.8414 27C12.8414 28.1922 13.8078 29.1586 15 29.1586L15 24.8414ZM41.5264 28.5264C42.3693 27.6834 42.3693 26.3166 41.5264 25.4736L27.7892 11.7364C26.9462 10.8935 25.5794 10.8935 24.7364 11.7364C23.8935 12.5794 23.8935 13.9462 24.7364 14.7892L36.9473 27L24.7364 39.2108C23.8935 40.0538 23.8935 41.4206 24.7364 42.2636C25.5794 43.1065 26.9462 43.1065 27.7892 42.2636L41.5264 28.5264ZM15 29.1586L40 29.1586L40 24.8414L15 24.8414L15 29.1586Z"
                fill="#3D3FF6"
              />
            </svg>
          </div>
